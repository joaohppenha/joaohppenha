...
- Modelagem de dados e criação de métricas no Power BI
- Construção de visualizações de dados (gráficos, mapas, indicadores)
...
- Integração Python ↔ MySQL com mysql-connector-python
- Desenvolvimento CLI em Python para cadastro e consulta de registros
- Geração automática de qualificações de petições em `.txt`
- Visualização de dados em tabelas no terminal (tabulate)
- Extração e análise de dados com consultas SQL
